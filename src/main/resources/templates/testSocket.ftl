...
<style type="text/css">
    ...
    <script type="text/javascript" src="/eimapp/js/jquery/jquery.min.js"></script>
    <script src="/eimapp/js/sockjs-1.1.1.js"></script>
...
//            ws= new WebSocket("ws://192.168.85.3:9095/eimapp/websck");
//        }else {
            ws = new SockJS("http://192.168.85.3:9095/eimapp/sockjs/websck/info?whiteboardToken=kashfasdkjhfadsf.fasgfagdasfdfasgasgfasd.asgdsfgdfasgdfsg0asfdsfghdfs02354120435405340");
//        }
        ws.onopen = function () {
            setConnected(true);
