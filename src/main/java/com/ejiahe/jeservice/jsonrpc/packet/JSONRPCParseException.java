 ...
 */
public class JSONRPCParseException extends Exception {
	 ...
	 */
	public JSONRPCParseException(final String message) {
	 ...
	 */
	public JSONRPCParseException(final String message, final String unparsableString) {
	 ...
	 * @param unparsableString The unparsable string.
	 */
	public JSONRPCParseException(final String message, final int causeType, final String unparsableString) {
