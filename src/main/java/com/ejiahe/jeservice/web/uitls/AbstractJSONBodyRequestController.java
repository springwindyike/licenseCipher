 ...
 * @author MaiLingFeng
 */
public class AbstractJSONBodyRequestController extends AbstractJSONRPCExceptionHandlerController {

    private static final String BODY_ATTR = "body";
    private static Logger LOG = LoggerFactory.getLogger(AbstractJSONBodyRequestController.class);
