...
public class AppUtil {
	 ...
	 * @return
	 */
	public static String makeSessionIdFromUserIds(String loginUserId, String chatId){
	...
	public static String createStringSql(Collection<String> list){
		String sql = "";
	...
	public static String createIntSql(Collection<Integer> list){
		String sql = "";
	 ...
	 * @return
	 */
	public static String createDurationTime(int duration){
		String hourStr = "";
		String minuteStr = "";
		String secondStr = "";
		if(duration == 0){
