...
package com.ejiahe.jeservice.util.cert;
...
public class CertificateManager {
    ...
    public static X509Certificate createDSACert(KeyStore ksKeys, String keyPassword, String alias, String issuerDN,
        ...
        X509Certificate cert = createX509V3Certificate(keyPair, 60, issuerDN, subjectDN, domain, "SHA256withDSA");
    ...
    public static X509Certificate createRSACert(KeyStore ksKeys, String keyPassword, String alias, String issuerDN,
        ...
        // Create X509 certificate with keys and specified domain
        X509Certificate cert = createX509V3Certificate(keyPair, 60, issuerDN, subjectDN, domain, "SHA256WithRSAEncryption");
        // Store new certificate and private key in the keystore
        ksKeys.setKeyEntry(alias, keyPair.getPrivate(), keyPassword.toCharArray(), new X509Certificate[]{cert});
        // Notify listeners that a new certificate has been created
        for (CertificateEventListener listener : listeners) {
     ...
     * certificate is going to be returned. Use {@link #installReply(KeyStore, KeyStore, String, String, InputStream, boolean, boolean)}
    ...
    public static String createSigningRequest(X509Certificate cert, PrivateKey privKey) throws Exception {
        ...
        String signatureAlgorithm = "DSA".equals(pubKey.getAlgorithm()) ? "SHA256withDSA" : "SHA256WITHRSAENCRYPTION";
...
//        X509v3CertificateBuilder builder = new JcaX509v3CertificateBuilder(new X500Name(issuerDN), serial, 
//        		new Date(System.currentTimeMillis()), new Date(System.currentTimeMillis() + months * (1000L * 60 * 60 * 24 * 30)),
//        		new X500Name(subjectDN), pubKey);
//        
//        JcaX509ExtensionUtils extUtils = new JcaX509ExtensionUtils();
//        
//        builder.addExtension(Extension.authorityKeyIdentifier,
//                false, extUtils.createAuthorityKeyIdentifier(pubKey))
//			  .addExtension(Extension.subjectKeyIdentifier,
//			                false, extUtils.createSubjectKeyIdentifier(pubKey))
...
//        GeneralNames subjectAltNames = new GeneralNames(new GeneralName[]{othernameGN});
//        // Add subject alternative name extension
//        builder.addExtension(X509Extensions.SubjectAlternativeName, critical, subjectAltNames);
//        
//        
//        ContentSigner signer;
//		try {
//			signer = new JcaContentSignerBuilder(signAlgoritm)
